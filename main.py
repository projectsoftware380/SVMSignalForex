...
forex_analyzer = ForexAnalyzer(config['api_key_polygon'], config['api_token_forexnews'])
forex_reversal_analyzer = ForexReversalAnalyzer(config['api_key_polygon'])
forex_signal_analyzer = ForexSignalAnalyzer(config['api_key_polygon'])
